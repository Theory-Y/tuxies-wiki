...
- [GPU Guide](/guides/gpu/)
- [ASUS Laptop Control (asusctl)](/guides/asusctl/)
...
- **Verify**
  ...
  # output is in microseconds — divide by 1,000,000 for seconds
  ```
...
:::tip Results on our unit (AMD AI HX370, NVIDIA 4060, 32 GB)
